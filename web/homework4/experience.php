...
$experience = [
  'job_title' => ['Front End-разработчик', 'Веб-разработчик / something.com', 'Графический дизайнер / designsomething.com'],
  'date_begin' => ['Январь 2015', 'Март 2012', 'Июнь 2010'],
  'date_end' => ['Current', 'Декабрь 2014', 'Март 2012'],
  'description' => ['Frontenders are responsible for the logical operation of all website components.',
   'Web development is the most popular direction in programming.', 'Through visual images, a person reads the meanings.']
];?>
...
<?php for ($i = 0; $i < count($experience['job_title']); $i++): ?>       
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $experience['job_title'][$i];?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience['date_begin'][$i];?> - <?php 
          if ($experience['date_end'][$i] == 'Current'): echo '<span class="w3-tag w3-teal w3-round">Настоящее время</span>'; 
          else: echo $experience['date_end'][$i]; endif;?></h6>
          <p><?php echo $experience['description'][$i];?></p>
          <hr>
        </div>
<?php endfor;?>
      </div>
